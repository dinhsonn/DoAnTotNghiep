    ...
    return ( 
        ...
        <section className="content-header my-2">
           ...
           <div className="text-end">
              <Link to={"/page"} className="btn btn-sm btn-success">
           ...
           <div className="row">
              <div className="col-md-9">
                 <div className="mb-3">
                    ...
                    <input type="text" name="title" className="form-control" placeholder="Nhập tiêu đề" />
                 </div>
                 <div className="mb-3">
                    <label><strong>Chi tiết (*)</strong></label>
                    <textarea name="detail" rows="7" className="form-control"
