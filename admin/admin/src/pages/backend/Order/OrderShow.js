        ...
        <section className="content-body my-2">
           ...
           <div className="row">
              <div className="col-md">
                 ...
                 <input type="text" name="name" value="" className="form-control" readonly />
              </div>
              <div className="col-md">
                 <label><strong>Email (*)</strong></label>
                 <input type="text" name="email" value="" className="form-control" readonly />
              </div>
              <div className="col-md">
                 <label><strong>Điện thoại (*)</strong></label>
                 <input type="text" name="phone" value="" className="form-control" readonly />
              </div>
              <div className="col-md-5">
                 <label><strong>Địa chỉ (*)</strong></label>
                 <input type="text" name="address" value="" className="form-control" readonly />
              </div>
           </div>
