...
public interface OrderService {
    ...
    void addItemToOrder(Long userId, Long productId, String name, String email, String phone,
                        String address,String homeAddress, int qty, double price, String image, String paymentMethod);
